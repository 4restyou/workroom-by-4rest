...
export default function PriceCard({ pass }: PriceCardProps) {
  return (
    <article className="rounded-card border-2 border-workroom-line bg-workroom-surface p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <p className="shrink-0 rounded-full border-2 border-workroom-line bg-workroom-yellow px-3 py-1 text-sm font-black">
