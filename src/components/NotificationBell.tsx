...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      {open ? (
        <div className="absolute right-0 top-[calc(100%+10px)] z-50 w-[min(20rem,calc(100vw-2rem))] animate-pop-in rounded-card border border-workroom-ink bg-workroom-surface p-4">
