  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: [
          "월권(자유석·지정석) 정기결제는 다음 결제일 전에 언제든 해지할 수 있으며, 해지 후 추가 결제는 발생하지 않습니다.",
          "해당 이용 기간 시작 전 취소 시 전액 환불됩니다.",
          "이용 기간 중 환불을 원하면 이용한 일수를 일할 계산해 차감한 잔액을 환불해 드립니다.",
          "정기결제 신청·해지·환불은 운영자에게 문의해 주세요.",
        ],
      },
    ],
  },
