...
![『가여운 것들』의 화면](images/poor-things-hall.avif)
*『가여운 것들』(2023). Photo by Atsushi Nishijima. Courtesy of Searchlight Pictures.*
...
- 이미지 4컷 배치됨(content/articles/images/): poor-things-bella.jpg(히어로),
  yorgos-nyc-2018.avif(만나다), the-favourite.avif(1~2미터), poor-things-hall.avif
  (필름). ⚠️ **모두 © Atsushi Nishijima / Searchlight Pictures(또는 작가 본인)**.
  **공개 전 반드시 라이선스/사용허가 확보 후 사용**할 것. 크레딧 형식: "Photo by
  Atsushi Nishijima. Courtesy of Searchlight Pictures."
- 다른 후보 이미지도 다수 보유(요청 시 교체/추가 가능).
